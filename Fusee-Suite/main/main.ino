...
#ifdef JOYCON_STRAP_PIN_PA
    EEPROM_JOYCON_CONTROL_STRAP_PA = JOYCON_STRAP_PIN_PA;
#else
    EEPROM_JOYCON_CONTROL_STRAP_PA = 0;
#endif

#ifdef VOLUP_STRAP_PIN_PA      
    EEPROM_VOL_CONTROL_STRAP_PA = VOLUP_STRAP_PIN_PA;
#else
    EEPROM_VOL_CONTROL_STRAP_PA = 0;
#endif

#ifdef USB_LOW_RESET_PA
    EEPROM_USB_STRAP_PA = USB_LOW_RESET_PA;
#else
    EEPROM_USB_STRAP_PA = 0;
#endif

    EEPROM_JOYCON_CONTROL_STRAP = 0;
    EEPROM_VOL_CONTROL_STRAP = 0;
    //usb low reset underneath
